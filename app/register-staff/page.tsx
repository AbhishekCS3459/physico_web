          ...
          <div className="relative bg-background/80 backdrop-blur-md rounded-3xl border border-border/50 shadow-2xl p-8 md:p-10">
            ...
            >
              ...
              <p className="text-muted-foreground text-sm md:text-base">
                Register to access the dashboard and patient charts. New accounts are created as staff by default.
              </p>
            </motion.div>
            ...
            >
              ...
              <div className="space-y-2">
                ...
                <div className="relative group">
                  ...
                  <Input
                    id="email"
                    type="email"
                    placeholder="staff@physiorehab.com"
                    value={email}
              ...
              <div className="space-y-2">
                ...
                <div className="relative group">
                  <Lock className="absolute left-4 top-1/2 -translate-y-1/2 text-muted-foreground h-5 w-5 z-10" />
                  <Input
                    id="password"
