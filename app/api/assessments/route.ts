...
const assessmentSchema = z.object({
  ...
  romFollowupExtension: z.string().optional(),
  romFollowupAbduction: z.string().optional(),
  romFollowupAdduction: z.string().optional(),
  romFollowupInternalRotation: z.string().optional(),
  romFollowupExternalRotation: z.string().optional(),
  strengthFollowupFlexion: z.string().optional(),
  strengthFollowupExtension: z.string().optional(),
  strengthFollowupAbduction: z.string().optional(),
  strengthFollowupAdduction: z.string().optional(),
  strengthFollowupInternalRotation: z.string().optional(),
  strengthFollowupExternalRotation: z.string().optional(),
  ...
  try {
    ...
    const assessment = await prisma.assessment.create({
      data: {
        ...
        romFollowupExtension: validatedData.romFollowupExtension,
        romFollowupAbduction: validatedData.romFollowupAbduction,
        romFollowupAdduction: validatedData.romFollowupAdduction,
        romFollowupInternalRotation: validatedData.romFollowupInternalRotation,
        romFollowupExternalRotation: validatedData.romFollowupExternalRotation,
        strengthFollowupFlexion: validatedData.strengthFollowupFlexion,
        strengthFollowupExtension: validatedData.strengthFollowupExtension,
        strengthFollowupAbduction: validatedData.strengthFollowupAbduction,
        strengthFollowupAdduction: validatedData.strengthFollowupAdduction,
        strengthFollowupInternalRotation: validatedData.strengthFollowupInternalRotation,
        strengthFollowupExternalRotation: validatedData.strengthFollowupExternalRotation,
