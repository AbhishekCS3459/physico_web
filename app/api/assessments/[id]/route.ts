...
const updateAssessmentSchema = z.object({
  ...
  romFollowupExtension: z.string().optional().nullable(),
  romFollowupAbduction: z.string().optional().nullable(),
  romFollowupAdduction: z.string().optional().nullable(),
  romFollowupInternalRotation: z.string().optional().nullable(),
  romFollowupExternalRotation: z.string().optional().nullable(),
  strengthFollowupFlexion: z.string().optional().nullable(),
  strengthFollowupExtension: z.string().optional().nullable(),
  strengthFollowupAbduction: z.string().optional().nullable(),
  strengthFollowupAdduction: z.string().optional().nullable(),
  strengthFollowupInternalRotation: z.string().optional().nullable(),
  strengthFollowupExternalRotation: z.string().optional().nullable(),
