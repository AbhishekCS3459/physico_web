      ...
      <div className="container mx-auto px-3 sm:px-4">
        <div className="flex h-14 sm:h-16 items-center justify-between">
          ...
          <Link href="/" className="flex items-center space-x-2 min-w-0">
            ...
            <span className="font-serif font-bold text-lg sm:text-xl text-foreground truncate">Physio Rehab</span>
          </Link>
          ...
          <nav className="hidden lg:flex items-center space-x-6 xl:space-x-8">
            {navigationItems.map((item) => (
              <Link
                ...
                href={item.href}
                className={cn(
                  "text-sm font-medium transition-colors hover:text-primary py-2 px-1",
            ...
            <Button size="sm" className="ml-4 px-4 py-2">
              Book Now
            </Button>
          </nav>

          {/* Tablet Navigation - Show condensed version */}
